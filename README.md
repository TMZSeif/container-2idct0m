...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2idct0m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2idct0m.containers.anotherwebservice.com/
...
```
git clone git@github.com:TMZSeif/container-2idct0m.git
cd container-2idct0m
```
...
```
docker attach container-2idct0m
```
